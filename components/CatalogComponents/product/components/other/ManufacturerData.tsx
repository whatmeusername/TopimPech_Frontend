	...
	return (
		<div className="product__card__manufacturer__data__wrapper">
			{product.manufacturer ? (
				<span className=" product__card__manufacturer__data product__card__manufacturer">
			...
			{product.type ? (
				<span className="product__card__manufacturer__data product__card__type">{product.type.name}</span>
			) : (
				''
			)}
		</div>
